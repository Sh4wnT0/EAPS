...
public class Try extends JFrame {
	...
	private JTextField NumberOfEmployee;
	...
	public Try() {
		...
		JLabel lblNewLabel = new JLabel("Enter Number of Employees:");
		lblNewLabel.setBounds(10, 19, 184, 13);
		contentPane.add(lblNewLabel);
		
		NumberOfEmployee = new JTextField();
		NumberOfEmployee.setBounds(200, 16, 96, 19);
		contentPane.add(NumberOfEmployee);
		NumberOfEmployee.setColumns(10);
		
		JButton btnNewButton_1 = new JButton("Start");
		textArea = new JTextArea();
		textArea.setLineWrap(true);
		textArea.setWrapStyleWord(true);
		btnNewButton_1.setBounds(306, 15, 85, 21);
		...
		btnAddTravelOrder.addActionListener(e -> {
			...
			if (ValiDate(getstart, "MM-DD-YYYY") && ValiDate(getend, "MM-dd-yyyy") ) {
				textArea.setText("\n Invalid Input. Please Enter a alid date.");
	            return;
			}
		...
		btnDisplayDetails.addActionListener(e -> {
			...
			btnNewButton_1.addActionListener(new ActionListener() {
				...
				String input = NumberOfEmployee.getText();
					int number = Integer.parseInt(input);
					num = number;
					textField.setText("Start inputting your Name.");
					textField_1.setText("Start inputting your ID.");
